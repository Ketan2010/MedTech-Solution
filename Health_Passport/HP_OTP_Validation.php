		...
		<div class="boxone">
			...
			<table style="margin-top: 15%;">
				<tr>
					...
					<td>
						<input class="inputs"  type="text" style="width:100%" name="otp" placeholder="Enter OTP...." aria-required="true"/>
					</td>
				<tr>
					<td colspan="2">
						<input style="font-size:20px" class="custom_buttons" type="button" value="Verify" name="Send_otp" />
					</td>
				</tr>
				</table>
